      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <!-- Classic Heading -->
            <h4 class="classic-title"><span>WE ARE HERE TO HELP - CONTACT US</span></h4>
            ...
            <!-- Info - Icons List -->
            <ul class="icons-list">
              <li><i class="fa fa-globe">  </i> <strong>Address:</strong>  Hay elundalos, Tripoli, Libya</li>
              <li><i class="fa fa-envelope-o"></i> <strong>Email:</strong> o.rihan@erawin.com.ly </li>
            ...
            <ul class="list-unstyled">
              <li><strong>Sunday - Thurisday</strong> - 8:30am to 5pm</li>
          ...
          <div class="col-md-3">
            <div class="footer-widget mail-subscribe-widget">
              ...
              <form class="subscribe" method="GET" action="mailto:o.rihan@erawin.com.ly" enctype="text/plain">
                <input name="Message" type="text" placeholder="mail@example.com">
